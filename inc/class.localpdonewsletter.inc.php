 ...
 */
class PdoNewsletter {
	private static $serveur='mysql:host=trsrv.ddns.net'; // version dev = trsrv.ddns.net // version prod = trsrv.no-ip.org
	private static $bdd='dbname=newsletter';
	private static $user='thierry' ; // version dev = thierry // version prod = root
